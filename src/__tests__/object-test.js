...
describe('validated/object', function() {
  describe('string', function() {
    ...
    itDoesNotValidate('1', schema, 1, {
      format: ['Expected value of type string but got number'].join('\n'),
    });
    itDoesNotValidate('true', schema, true, {
      format: ['Expected value of type string but got boolean'].join('\n'),
    });
  });
  ...
  describe('number', function() {
    ...
    itDoesNotValidate('"ok"', schema, 'ok', {
      format: ['Expected value of type number but got string'].join('\n'),
    });
    itDoesNotValidate('true', schema, true, {
      format: ['Expected value of type number but got boolean'].join('\n'),
    });
  });
  ...
  describe('boolean', function() {
    ...
    itDoesNotValidate('1', schema, 1, {
      format: ['Expected value of type boolean but got number'].join('\n'),
    });
    itDoesNotValidate('"ok"', schema, 'ok', {
      format: ['Expected value of type boolean but got string'].join('\n'),
    });
  });
  ...
  describe('object', function() {
    describe('with fields', function() {
      ...
      itDoesNotValidate(
        ...
        {c: 3},
        {
          format: ['Unexpected key: "c"', 'While validating key "c"'].join('\n'),
        },
      );
      itDoesNotValidate(
        '{a: 1, b: 2, c: 3}',
  ...
  describe('enumeration', function() {
    ...
    itValidates('"ok"', schema, 'ok', 'ok');
    itDoesNotValidate('1', schema, 1, {
      format: ['Expected value to be one of 42, "ok" but got 1'].join('\n'),
    });
  });
